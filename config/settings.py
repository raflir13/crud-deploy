...
ALLOWED_HOSTS = [
    'localhost',
    '127.0.0.1',
    'raflir13.pythonanywhere.com',  # Akan match yourusername.pythonanywhere.com
]
...
INSTALLED_APPS = [
    ...
    'rest_framework',
    # 'corsheaders',  # Uncomment jika butuh CORS
    'notes',
]
...
MIDDLEWARE = [
    ...
    # 'corsheaders.middleware.CorsMiddleware',  # Uncomment jika butuh CORS
...
# CORS Settings (jika frontend terpisah)
